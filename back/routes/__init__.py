...
from routes.cliente.cliente_info import cliente_bp  # Importación correcta
...
def register_routes(app):
    ...
    app.register_blueprint(auth_bp, url_prefix='/api/auth')  # Mejor prefijo
    app.register_blueprint(cliente_bp, url_prefix='/api/clientes')  # Usar cliente_bp
